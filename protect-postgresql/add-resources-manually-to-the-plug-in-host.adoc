...
.Passos
. No painel de navegação esquerdo, selecione o SnapCenter Plug-in para Postgresql na lista suspensa e clique em *Recursos*.
. Na página Recursos, clique em *Adicionar recursos do Postgresql*.
...
. Opcional: Na página Configurações de Recursos, para recursos no host do Windows, insira pares de chave-valor personalizados para o plug-in PostgreSQL
