...
summary: Antes de adicionar um host e instalar os pacotes de plug-in, você deve concluir todos os requisitos.  O plug-in SnapCenter para PostgreSQL está disponível em ambientes Windows e Linux. 
---
...
Para executar um comando suplementar no SnapCenter Plug-in para PostgreSQL, você deve incluí-lo no arquivo _allowed_commands.config_.
