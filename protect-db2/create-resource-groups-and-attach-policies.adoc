...
NOTE: Os pares de chave-valor personalizados são suportados para sistemas de plug-in IBM Db2 Linux e não são suportados para o banco de dados IBM Db2 registrado como um plug-in centralizado do Windows.
