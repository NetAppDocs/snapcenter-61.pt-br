...
summary: Antes de adicionar um host e instalar os pacotes de plug-in, você deve concluir todos os requisitos.  Plug-in SnapCenter para IBM Db2 compatível com ambientes Windows, Linux e AIX. 
---
...
Para executar um comando suplementar no SnapCenter Plug-in para IBM Db2, você deve incluí-lo no arquivo _allowed_commands.config_.
