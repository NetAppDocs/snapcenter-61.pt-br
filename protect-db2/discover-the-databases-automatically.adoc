...
summary: Os recursos são bancos de dados IBM Db2 no host Linux que são gerenciados pelo SnapCenter.  Você pode adicionar esses recursos a grupos de recursos para executar operações de proteção de dados depois de descobrir os bancos de dados IBM Db2 que estão disponíveis. 
---
...
.Passos
. No painel de navegação esquerdo, clique em *Recursos* e selecione o Plug-in para IBM Db2 na lista.
