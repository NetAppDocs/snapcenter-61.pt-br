...
summary: 'O SnapCenter oferece suporte a SnapRestore baseado em volume (VBSR), Single File SnapRestore e tipos de restauração de conexão e cópia para bancos de dados IBM Db2 descobertos automaticamente.' 
---
