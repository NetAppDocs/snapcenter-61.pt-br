...
+
link:../protect-db2/configure-gMSA-on-windows-server-2012-or-later.html["Configurar conta de serviço gerenciada de grupo no Windows Server 2016 ou posterior para IBM Db2"^]
...
NOTE: O plug-in para IBM Db2 é instalado no host do cliente IBM Db2, e esse host pode estar em um sistema Windows ou Linux.
...
Caminho de instalação
 a| 
O plug-in para IBM Db2 é instalado no host do cliente IBM Db2, e esse host pode estar em um sistema Windows ou Linux.
...
+
** Para o plug-in do Windows, os logs de instalação e atualização estão localizados em: _C:\Windows\ SnapCenter plugin\Install_<JOBID>\
