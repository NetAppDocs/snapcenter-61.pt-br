...
sidebar: sidebar 
keywords: SnapCenter 
summary: Você deve definir uma estratégia antes de poder executar com sucesso operações de restauração usando o SnapCenter.  Há dois tipos de estratégias de restauração para recursos do IBM Db2 adicionados manualmente.  Não é possível recuperar recursos do IBM Db2 adicionados manualmente. 
---
