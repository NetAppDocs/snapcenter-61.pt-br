...
summary: Você pode usar o SnapCenter para restaurar bancos de dados do Exchange restaurando um ou mais backups para seu sistema de arquivos ativo. 
---
