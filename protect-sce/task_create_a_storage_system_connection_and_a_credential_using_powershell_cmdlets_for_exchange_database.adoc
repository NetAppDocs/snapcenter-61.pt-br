...
summary: 'Você deve criar uma conexão de máquina virtual de armazenamento (SVM) e uma credencial antes de usar cmdlets do PowerShell para fazer backup e restaurar.' 
---
...
----
. Crie uma nova conexão com o sistema de armazenamento usando o `Add-SmStorageConnection` cmdlet.
+
