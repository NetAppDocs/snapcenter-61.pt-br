...
summary: Restaurar um backup de recursos inclui iniciar uma sessão de conexão com o SnapCenter Server, listar os backups e recuperar informações de backup, além de restaurar um backup. 
---
