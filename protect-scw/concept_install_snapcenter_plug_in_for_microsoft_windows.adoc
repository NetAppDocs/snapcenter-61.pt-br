...
sidebar: sidebar 
keywords: installing 
summary: Você deve instalar e configurar o SnapCenter Plug-in para Microsoft Windows se quiser proteger arquivos do Windows que não sejam arquivos de banco de dados. 
---
...
image::../media/scw_workflow_for_installing.gif[fluxo de trabalho de instalação]
