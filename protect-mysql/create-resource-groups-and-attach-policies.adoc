...
NOTE: Os pares de chave-valor personalizados são suportados por sistemas de plug-in MySQL Linux e não são suportados por bancos de dados MySQL registrados como um plug-in centralizado do Windows.
