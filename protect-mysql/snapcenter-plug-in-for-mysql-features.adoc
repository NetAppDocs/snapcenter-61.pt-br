...
summary: O SnapCenter integra-se ao aplicativo plug-in e às tecnologias NetApp no ​​sistema de armazenamento.  Para trabalhar com o Plug-in para Banco de Dados MySQL, use a interface gráfica do usuário do SnapCenter . 
---
