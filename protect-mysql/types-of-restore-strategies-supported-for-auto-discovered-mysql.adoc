...
summary: Você deve definir uma estratégia antes de poder executar com sucesso operações de restauração usando o SnapCenter.  Existem dois tipos de estratégias de restauração para bancos de dados MySQL descobertos automaticamente. 
---
