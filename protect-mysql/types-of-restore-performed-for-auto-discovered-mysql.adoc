...
summary: 'O SnapCenter oferece suporte a SnapRestore baseado em volume (VBSR), Single File SnapRestore e tipos de restauração de conexão e cópia para bancos de dados MySQL descobertos automaticamente.' 
---
...
[role="lead"]
O plug-in SnapCenter para MySQL oferece suporte a Single File SnapRestore e tipos de restauração de conexão e cópia para bancos de dados MySQL descobertos automaticamente.
