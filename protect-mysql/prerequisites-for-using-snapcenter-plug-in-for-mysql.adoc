...
summary: Antes de usar o SnapCenter Plug-in para MySQL, o administrador do SnapCenter deve instalar e configurar o SnapCenter Server e executar as tarefas de pré-requisito. 
---
