...
summary: Cada solicitação de API gera uma resposta ao cliente. Você deve examinar a resposta para determinar se ela foi bem-sucedida e recuperar dados adicionais conforme necessário. 
---
