...
summary: Você pode usar o arquivo executável do instalador do SnapCenter Server para atualizar o SnapCenter Server. 
---
...
+
Para obter informações, consultelink:../admin/concept_manage_the_snapcenter_server_repository.html#back-up-the-snapcenter-repository["Faça backup do repositório SnapCenter"^] .
...
.Passos
. Baixe o pacote de instalação do SnapCenter Server no site de suporte da NetApp .
+
https://mysupport.netapp.com/site/products/all/details/snapcenter/downloads-tab[]

. Crie uma cópia do web.config localizado em C:\Program Files\ NetApp\ SnapCenter WebApp.
...
. Crie o dump do banco de dados MySQL do SnapCenter se o backup do repositório não estiver configurado.
+
...
* Se o plug-in for instalado usando um usuário sudo, você deverá copiar as chaves sha224 disponíveis em _C:\ProgramData\ NetApp\ SnapCenter\Package Repository\sc_unix_plugins_checksum.txt_ para atualizar o arquivo _/etc/sudoers_.
