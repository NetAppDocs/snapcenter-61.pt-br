...
summary: O SnapCenter software é uma plataforma simples, centralizada e escalável que fornece proteção de dados consistente para aplicativos, bancos de dados, sistemas de arquivos host e VMs em execução em sistemas ONTAP em qualquer lugar na Nuvem Híbrida. 
---
...
* SnapLock https://docs.netapp.com/us-en/ontap/snaplock/["Saber mais"]
* Sincronização ativa do SnapMirror (inicialmente lançado como SnapMirror Business Continuity [SM-BC])
* Espelhamento síncrono https://docs.netapp.com/us-en/e-series-santricity/sm-mirroring/overview-mirroring-sync.html["Saber mais"]
...
image::../media/saphana-br-scs-image6.png[Figura mostrando diálogo de entrada/saída ou representando conteúdo escrito]
...
Linux ou Windows
 ...
 a| 
Plug-in SnapCenter para MongoDB
 a| 
Pacote de plug-ins para Linux e pacote de plug-ins para Windows
 a| 
Plug-in para UNIX ou plug-in para Windows
...
Linux ou Windows
 ...
 a| 
Plug-in SnapCenter para ORASCPM (Aplicativos Oracle)
 a| 
Pacote de plug-ins para Linux e pacote de plug-ins para Windows
 a| 
Plug-in para UNIX ou plug-in para Windows
...
Linux ou Windows
 ...
 a| 
Plug-in SnapCenter para SAP ASE
 a| 
Pacote de plug-ins para Linux e pacote de plug-ins para Windows
 a| 
Plug-in para UNIX ou plug-in para Windows
...
Linux ou Windows
 ...
 a| 
Plug-in SnapCenter para plug-in de armazenamento
 a| 
Pacote de plug-ins para Linux e pacote de plug-ins para Windows
 a| 
Plug-in para UNIX ou plug-in para Windows
 a| 
Host de armazenamento
 a| 
Linux ou Windows
...
Para proteger bancos de dados, sistemas de arquivos, VMs ou armazenamentos de dados em VMs, implante o SnapCenter Plug-in for VMware vSphere . Para obter informações, consulte https://docs.netapp.com/us-en/sc-plugin-vmware-vsphere/index.html["Documentação do SnapCenter Plug-in for VMware vSphere"^] .
