...
O disco compartilhado não é criado usando o Plug-in for Windows. Você deve criar e, em seguida, adicionar o LUN compartilhado a cada máquina virtual no cluster.



=== Informações relacionadas

Consulte  https://techdocs.broadcom.com/["Documentação técnica Broadcom"^] e pesquise a documentação sobre clustering de máquinas virtuais em hosts físicos e criação de LUNs FC RDM compartilhadas para clusters Microsoft.
