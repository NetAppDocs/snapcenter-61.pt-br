...
summary: Uma impressão digital de certificado é uma sequência hexadecimal que identifica um certificado.  Uma impressão digital é calculada a partir do conteúdo do certificado usando um algoritmo de impressão digital. 
---
