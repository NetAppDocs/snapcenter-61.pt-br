...
summary: Você deve criar funções de cluster ONTAP para sistemas ASA r2 para que não precise usar a função de administrador ONTAP para executar operações no SnapCenter. 
---
