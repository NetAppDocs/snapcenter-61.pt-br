...
summary: O serviço SnapCenter Plug-in Loader carrega o pacote de plug-in para Linux interagir com o SnapCenter Server.  O serviço SnapCenter Plug-in Loader é instalado quando você instala o SnapCenter Plug-ins Package para Linux. 
---
