...
summary: 'Você pode restaurar um subconjunto de tablespaces que foi corrompido ou descartado sem afetar os outros tablespaces no banco de dados.  O SnapCenter usa o RMAN para executar a recuperação pontual (PITR) dos tablespaces.' 
---
...
.. Selecione *Tablespaces* e especifique os tablespaces que deseja restaurar.
+
