...
sidebar: sidebar 
keywords:  
summary: Você pode cancelar operações de backup que estejam em execução, na fila ou que não respondam. 
---
...
Painel de atividades
 a| 
. Após iniciar o trabalho de backup, clique emimage:../media/activity_pane_icon.gif["ícone do painel de atividades"] no painel Atividade para visualizar as cinco operações mais recentes.
