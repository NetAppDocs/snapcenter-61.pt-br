...
+
.. Se você selecionar *Recurso Completo*, todos os volumes de dados configurados do banco de dados SAP HANA serão restaurados.
+
...
.. Se você selecionar *Nível de arquivo*, poderá selecionar *Todos* ou selecionar os volumes ou qtrees específicos e, em seguida, inserir o caminho relacionado a esses volumes ou qtrees, separados por vírgulas
+
