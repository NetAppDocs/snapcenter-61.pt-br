...
.Passos
. Determinar as estratégias de restauração suportadas para recursos SAP HANA adicionados manualmente
. Determinar as estratégias de restauração suportadas para bancos de dados SAP HANA descobertos automaticamente
