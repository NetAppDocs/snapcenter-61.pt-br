...
. Decida se você deseja criar uma política baseada em cópia de Snapshot para fazer backup de Snapshots consistentes com o aplicativo do banco de dados.
. Decida se você deseja verificar a integridade do banco de dados.
