...
sidebar: sidebar 
keywords: SnapCenter 
summary: Configurar o certificado CA para o serviço de plug-ins suportados pela NetApp no ​​host Linux 
---
...
.Passos
. Você pode modificar e atualizar o diretório padrão no arquivo agent.properties em relação à chave CRL_PATH.
+
